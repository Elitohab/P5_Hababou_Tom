// On ,et dqns une vqriqble l'qdresse qui nous per;et de r2cup2rer tous les produits
        ...
        `<div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3 mt-4">
            <a href="article.html?id=${produit._id}">
                <div class="card carte">
                    <img class="card-img-top p-1 carte__image" src="${produit.imageUrl}" alt="Nounours ${produit.name}">
